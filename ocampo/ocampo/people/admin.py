...
from django.contrib import admin
from ocampo.people.models import People, Book, ContributionRolePersonContribution, ContributionRoleType, Contribution, Correspondence, DescriptiveBibliography, Place
